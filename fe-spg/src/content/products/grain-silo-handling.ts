...
const galleryAssets: Record<GrainSiloSectionId, readonly GalleryAsset[]> = {
  "air-cushion-conveyor": [
    asset(
      "9e1afb5a96012cf5eaa818f316aa345c_lp.jpg",
      "Dongjiakou granary",
      "Kho ngũ cốc Dongjiakou",
      "董家口粮仓",
    ),
    asset(
      "ea2be8105e7657e6147c60fc4feab144_lp.jpg",
      "Rizhao Port - Lanshan bulk grain",
      "Hệ thống ngũ cốc rời Lanshan, Cảng Nhật Chiếu",
      "日照港-岚山散粮",
    ),
    asset(
      "a3f06ee468a711f2c2c2a1e93d0e9f77_lp.jpg",
      "Rizhao Port - Lanshan bulk grain",
      "Hệ thống ngũ cốc rời Lanshan, Cảng Nhật Chiếu",
      "日照港-岚山散粮",
    ),
    asset(
      "74b80eebe4e0d49f974555dcdbd467c4_lp.jpg",
      "Rizhao Port - Shijiu bulk grain",
      "Hệ thống ngũ cốc rời Shijiu, Cảng Nhật Chiếu",
      "日照港-石臼散粮",
    ),
    asset(
      "3d639a30a99badec42bb7ad53d9446ae_lp.jpg",
      "Rizhao Port - Lanshan bulk grain",
      "Hệ thống ngũ cốc rời Lanshan, Cảng Nhật Chiếu",
      "日照港-岚山散粮",
    ),
    asset(
      "93c6f5c7b07d4ca7ee63793f041a476c_lp.jpg",
      "Rizhao Port - Lanshan bulk grain",
      "Hệ thống ngũ cốc rời Lanshan, Cảng Nhật Chiếu",
      "日照港-岚山散粮",
    ),
    asset(
      "69612ced8788f6a0724a044f1faae1cf_lp.jpg",
      "Rizhao Port - Lanshan bulk grain",
      "Hệ thống ngũ cốc rời Lanshan, Cảng Nhật Chiếu",
      "日照港-岚山散粮",
    ),
    asset(
      "fb1cf507211d5fa0efe9197ba3b71880_lp.jpg",
      "Yantai Port - bulk grain transportation project",
      "Dự án vận chuyển ngũ cốc rời tại Cảng Yên Đài",
      "烟台港-散粮输送项目",
    ),
  ],
  "screw-ship-unloader": [
    asset(
      "c499f3e760a34d62c9be24e785be575e_lp.jpg",
      "Spiral bucket ship-unloader test bench",
      "Bệ thử máy dỡ tàu gầu xoắn",
      "螺旋带斗卸船机试验台",
    ),
    asset(
      "7c8c49ae7ab284870f5d274331b1bf3b_lp.jpg",
      "Spiral bucket ship-unloader test bench",
      "Bệ thử máy dỡ tàu gầu xoắn",
      "螺旋带斗卸船机试验台",
    ),
  ...
  "multi-purpose-portal-crane": [
    ...
    asset(
      ...
      "Cẩu chân đế 25T38M tại Hóa chất Xinpu Thái Hưng",
      "泰兴新浦化学-25T38M门机",
    ),
    asset(
  ...
  "loading-building": [
    asset(
      "aa016770df7fd37386e57885128b0070_lp.jpg",
      "Qingdao Port Dongjiakou North Third Jetty grain silo phase III",
      "Giai đoạn III silo ngũ cốc và hệ thống phụ trợ tại cầu cảng Bắc số 3 Dongjiakou, Cảng Thanh Đảo",
      "青岛港董家口港区北三突堤粮食筒仓三期及配套流程工程",
    ),
    asset(
      "58664039af211bbfc91370e58e7babcc_lp.jpg",
      "Lanshan Port south area bulk-grain system reconstruction and expansion",
      "Dự án cải tạo, mở rộng hệ thống lưu trữ và vận chuyển ngũ cốc rời khu phía Nam Cảng Lanshan",
      "日照港岚山港区南作业区散粮储运系统改扩建工程",
    ),
    asset(
      "e5f496261366219037da9bdfef1f08b3_lp.jpg",
      "Rizhao Port grain base project",
      "Dự án cơ sở ngũ cốc Cảng Nhật Chiếu",
      "日照港粮食基地工程",
    ),
    asset(
      "7647c078394f79509f31eaa5c1bd9e00_lp.jpg",
      "Lanshan Port south area bulk-grain system reconstruction and expansion 2",
      "Dự án cải tạo, mở rộng hệ thống ngũ cốc rời khu phía Nam Cảng Lanshan 2",
      "日照港岚山港区南作业区散粮储运系统改扩建工程2",
    ),
    asset(
      "524d5aa542a114243a8dd4517d374ab3_lp.jpg",
      "Lanshan Port south operation area railway project",
      "Dự án đường sắt khu khai thác phía Nam Cảng Lanshan",
      "日照港岚山港区南作业区铁路工程",
    ),
    asset(
      "972d1d611370318caecfa868c680b9dc_lp.jpg",
      "Rizhao Port grain base project",
      "Dự án cơ sở ngũ cốc Cảng Nhật Chiếu",
      "日照港粮食基地工程",
    ),
    asset(
      "9d045f2dbb1cc96ce0f14ca0200639b4_lp.jpg",
      "Transfer building",
      "Nhà trung chuyển",
      "转载楼",
    ),
    asset(
      "43322c09980b131a4b11133bb5fd33a9_lp.jpg",
      "Lanshan Port south area bulk-grain system reconstruction and expansion",
      "Dự án cải tạo, mở rộng hệ thống ngũ cốc rời khu phía Nam Cảng Lanshan",
      "日照港岚山港区南作业区散粮储运系统改扩建工程",
    ),
    asset(
      "15cbef167bb59008d2f76a94f8b0e022_lp.jpg",
      "Loading building",
      "Nhà xuất hàng",
      "装车楼",
    ),
...
> = {
  ...
  vi: {
    ...
    description:
      "Giải pháp tích hợp bốc dỡ, vận chuyển và lưu trữ ngũ cốc bằng silo của Tập đoàn Thiết bị Cảng Sealand Sơn Đông.",
    productsLabel: "Sản phẩm & Giải pháp",
    intro:
      "Cung cấp đầy đủ các sản phẩm tùy chỉnh gồm máy dỡ tàu gầu xoắn tự động, cẩu chân đế xếp dỡ cảng tự động, phễu, silo, nhà đóng bao, nhà xuất hàng và thiết bị phụ trợ, băng tải đệm khí, băng tải thường, băng tải ống tròn và xe vận chuyển container không người lái. Các chức năng tùy chọn gồm khử bụi và chống nổ, chống tắc nghẽn thông minh, quản lý trạng thái, bôi trơn thông minh, chữa cháy tự động, kiểm tra không người lái và chiếu sáng thông minh.",
  ...
  zh: {
    ...
    intro:
      "提供自动化螺旋卸船机、自动化港口装卸门座起重机、料斗、筒仓、灌包楼/装车楼及配套设备、气垫皮带机、皮带输送机、圆管带式输送机、无人集卡等全系列定制产品，并根据需求配套抑尘防爆、智能防堵料、智能状态管理系统、智能润滑、自动消防、无人巡检及智慧照明等功能。",
    previousLabel: "上一张图片",
    nextLabel: "下一张图片",
    galleryLabel: "产品图片",
  },
