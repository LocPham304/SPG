...
const galleryAssets: Record<BreakbulkSectionId, readonly GalleryAsset[]> = {
  ...
  "gantry-crane": [
    asset(
      "0d7a8a107a03cd0ce3d8189f9f8dba37.gif",
      "Automated rail-mounted gantry crane",
      "Cẩu giàn chạy ray tự động",
      "自动化轨道吊",
    ),
    asset(
      "769ca4adfaf9512c434455603c9f35d3_lp.jpg",
      "Qingdao Port QQCTN Phase III - 41T automated rail crane",
      "Cẩu ray tự động 41T giai đoạn III tại Cảng Thanh Đảo QQCTN",
      "青岛港QQCTN三期-41T自动化轨道吊",
    ),
    asset(
      "8fdcbe112f31d9712ac1cae3c0a462a0_lp.jpg",
      "Qingdao Port QQCTN Phase III - 41T automated rail crane 2",
      "Cẩu ray tự động 41T giai đoạn III số 2 tại Cảng Thanh Đảo QQCTN",
      "青岛港QQCTN三期-41T自动化轨道吊2",
    ),
    asset(
      "e3838acda191b7b9dea00042c67fb4b1_lp.jpg",
      "Qingdao Port QQCTU - 41T rail crane",
      "Cẩu ray 41T tại Cảng Thanh Đảo QQCTU",
      "青岛港QQCTU-41T轨道吊",
    ),
    asset(
      "af3cebb2d4d191de356e757b2731066e_lp.jpg",
      "Qingdao Port QQCTN Phase II - 41T automated rail crane",
      "Cẩu ray tự động 41T giai đoạn II tại Cảng Thanh Đảo QQCTN",
      "青岛港QQCTN二期-41T自动化轨道吊",
    ),
    asset(
      "d4beebbf207e05fa3a32319045e910f2_lp.jpg",
      "Yantai Longkou Port - 40.5T rail crane",
      "Cẩu ray 40,5T tại Cảng Long Khẩu, Yên Đài",
      "烟台龙口港-40.5T轨道吊",
    ),
    asset(
      "41c1500fd1bd988f5f046019aee9da8e_lp.jpg",
      "Qingdao Port QQCTN Phase I - 41T automated rail crane",
      "Cẩu ray tự động 41T giai đoạn I tại Cảng Thanh Đảo QQCTN",
      "青岛港QQCTN一期-41T自动化轨道吊",
    ),
  ],
  "steel-structure": [
    asset(
      "4cd40209849460e941ec198d4d918187_lp.jpg",
      "Yantai Hyundai Motor R&D Center project",
      "Dự án Trung tâm R&D Hyundai Motor tại Yên Đài",
      "烟台市·现代汽车研发中心项目",
    ),
    asset(
      "93e60d66c29c4debfab196c046737ea2_lp.jpg",
      "Qingdao Haitian Hotel super high-rise steel structure project",
      "Dự án kết cấu thép siêu cao tầng Khách sạn Haitian Thanh Đảo",
      "青岛市·海天大酒店超高层钢结构项目",
    ),
    asset(
      "9920b2461fe4d84efa328b3e686b17bc_lp.jpg",
      "Rizhao Ocean Park steel structure project",
      "Dự án kết cấu thép Công viên Đại dương Nhật Chiếu",
      "日照市·海洋公园钢结构工程",
    ),
    asset(
      "333e9b0ac19be18cd7e82fc39d62d82e_lp.jpg",
      "Qingdao Goertek Business Center steel structure project",
      "Dự án kết cấu thép Trung tâm Thương mại Goertek Thanh Đảo",
      "青岛市·歌尔商务中心钢结构项目",
    ),
    asset(
      "5aa6cfd7c784ba03c6c7c9b4ebc54ce0_lp.jpg",
      "Rizhao Port Shijiu breakbulk warehouse project",
      "Dự án kho hàng bách hóa khu cảng Shijiu, Cảng Nhật Chiếu",
      "日照港·日照港石臼港区件杂货库工程",
    ),
    asset(
      "c687c72dbb1a3e6f8b901ac025df3c5e_lp.jpg",
      "Jinan Distribution Center steel structure project",
      "Dự án kết cấu thép Trung tâm Phân phối Tế Nam",
      "济南市·济南分拨中心项目钢结构工程",
    ),
    asset(
      "46cfb8744bb308eb4c3225b7603f7203_lp.jpg",
      "Rizhao Culture Expo Center project",
      "Dự án Trung tâm Triển lãm Văn hóa Nhật Chiếu",
      "日照市·文化博览中心项目",
    ),
    asset(
      "c526bfe0249e6d36b5f99e7ad2107d36_lp.jpg",
      "Rizhao Culture Expo Center project",
      "Dự án Trung tâm Triển lãm Văn hóa Nhật Chiếu",
      "日照市·文化博览中心项目",
    ),
    asset(
      "4ecc50297351f6226561325c926d4f8e_lp.jpg",
      "Rizhao Ocean Park steel structure project",
      "Dự án kết cấu thép Công viên Đại dương Nhật Chiếu",
      "日照市·海洋公园钢结构工程",
    ),
    asset(
      "61a4d2a9a98e1e8dcf4cd85184e20d3f_lp.jpg",
      "Shanhaitian Sunshine Coast greenway floating bridge",
      "Cầu nổi đường xanh Bờ biển Ánh Dương tại khu nghỉ dưỡng Shanhaitian",
      "日照市·山海天阳光海岸绿道飘桥",
    ),
    asset(
      "e5f07e5c298bc7e8af09fd74a7939abc_lp.jpg",
      "Wulian Huangyachuan floating bridge",
      "Cầu nổi Huangyachuan tại Wulian",
      "日照市·五莲黄崖川飘桥",
    ),
    asset(
      "f6df6f0db6955709b2ae0eb7b2dd1893_lp.jpg",
      "Rizhao Lanshan District Government restaurant project",
      "Dự án nhà ăn Chính quyền quận Lanshan, Nhật Chiếu",
      "日照市·岚山区政府餐厅项目",
    ),
  ],
};
...
> = {
  en: {
    ...
    description:
      "Integrated breakbulk cargo handling and steel structure solutions from Shandong Port Equipment Group.",
    productsLabel: "Products & Solutions",
    intro:
      "Provide a full range of customized products such as automated port loading and unloading portal cranes, steel structure buildings, automatic rail cranes for general cargo and unmanned container trucks. Functions can be configured to demand, including multifunctional rotary spreaders and hooks, automatic collision avoidance, one-key automatic anchoring, intelligent status management, intelligent lubrication, automatic fire protection, intelligent lightning protection, intelligent gates and intelligent lighting.",
  ...
  vi: {
    ...
    description:
      "Giải pháp tích hợp xếp dỡ hàng bách hóa và kết cấu thép của Tập đoàn Thiết bị Cảng Sealand Sơn Đông.",
    productsLabel: "Sản phẩm & Giải pháp",
    intro:
      "Cung cấp đầy đủ các sản phẩm tùy chỉnh gồm cẩu chân đế xếp dỡ cảng tự động, công trình kết cấu thép, cẩu ray tự động chuyên dụng cho hàng bách hóa và xe vận chuyển container không người lái. Hệ thống có thể tích hợp theo nhu cầu khung nâng hoặc móc quay đa chức năng, chống va chạm tự động, neo tự động một chạm, quản lý trạng thái thông minh, bôi trơn và chữa cháy tự động, chống sét thông minh, cổng kiểm soát và chiếu sáng thông minh.",
  ...
  zh: {
    ...
    intro:
      "提供自动化港口装卸门座起重机、钢结构建筑、件杂货自动化专用轨道吊、无人集卡等全系列定制化产品，并根据需求配套多功能旋转吊具/吊钩、自动防撞、一键自动锚定、智能状态管理系统、智能润滑、自动消防、智能防雷、智慧闸口及智慧照明等功能。",
    previousLabel: "上一张图片",
    nextLabel: "下一张图片",
    galleryLabel: "产品图片",
  },
